...
#                         (file_id, nom, prenom, pseudo, email, password_hash, classe)
...
#             # En-têtes avec style
#             headers = ["Nom", "Prénoms", "Pseudo", "Email", "Mot de passe", "classe"]
...
#                 ws.cell(row=row_num, column=2, value=record["prenoms"])
#                 ws.cell(row=row_num, column=3, value=record["pseudo"])
